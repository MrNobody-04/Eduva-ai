      ...
      <div className="flex flex-col md:flex-row items-center justify-between gap-4">
        ...
        <div className="relative w-full md:w-72 shrink-0">
          ...
          <input
            ...
            className={`w-full pl-9 pr-3 py-2.5 rounded-xl border text-xs font-semibold focus:outline-none focus:ring-2 focus:ring-blue-500 ${
              theme === 'dark' ? 'bg-[#0B101E] border-slate-800/80 text-white' : 'bg-white border-slate-300 text-slate-900'
            }`}
          />
        </div>
      </div>
            ...
            <div className="space-y-3">
              <div className="flex items-start justify-between gap-2">
                <div>
                  ...
                  <span className="text-xs font-semibold text-blue-500">{college.university}</span>
                </div>
